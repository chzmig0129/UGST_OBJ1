...
def get_historico_poligonos_radio(polygon_id):
    """Endpoint para cargar y devolver los polígonos históricos dentro de un radio de 500m"""
    try:
        # Buscar el polígono en la base de datos
        ...
        # Filtrar polígonos en el radio de 500m
        ...
        def en_radio(geometry):
            ...
            # Retornar True si está dentro del radio (500m)
